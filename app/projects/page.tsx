...
import { TechStackChart, EngagementChart } from '../components/charts/LazyCharts';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `Browse ${totalProjects} projects by ${developerName}. Professional portfolio showcasing modern software development, React, Next.js, TypeScript, and other technologies.`,
