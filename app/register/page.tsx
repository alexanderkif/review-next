...
function RegisterForm() {
  ...
  if (registrationSuccess) {
    return (
      <div className="page-glass min-h-screen flex items-center justify-center p-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-600 hover:text-slate-800 transition-colors z-10"
                >
