          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit"
                variant="clay"
                className="w-full bg-gradient-to-r from-emerald-600 to-blue-600 text-white hover:text-white hover:from-emerald-500 hover:to-blue-500 shadow-[3px_3px_6px_#9ca3af,_-1.5px_-1.5px_6px_rgba(255,255,255,0.1),_inset_-2px_-2px_1px_rgba(0,0,0,0.3)] transition-all"
                disabled={loading}
              >
                {loading ? (
