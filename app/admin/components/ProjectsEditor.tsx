      ...
      {!showForm && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {projects.map((project) => (
            <Card key={project.id} variant="clay">
              <CardHeader>
                  ...
                  <div className="flex flex-wrap gap-1">
                    ...
                    {project.technologies.length > 3 && (
                      <span className="px-2 py-1 bg-slate-100 text-slate-500 text-xs rounded-lg">
                        +{project.technologies.length - 3} больше
                      </span>
                    )}
                  </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Short Description для карточки проекта"
                required
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white shadow-[inset_2px_2px_2px_#d1d1d1,_inset_-2px_-2px_2px_#ffffff] text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
            ...
            <div>
              <div>
                ...
                {(() => {
                  const imageUrls: string[] = Array.isArray(editingProject.image_urls) ? editingProject.image_urls : [];
                  const props = {
