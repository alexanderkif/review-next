  ...
  return (
    <div
      ...
      className={cn(
        ...
        hover && {
          'clay': variant === 'clay' && 'hover:shadow-[6px_6px_12px_#c5c5c5,_-3px_-3px_12px_#ffffff,_inset_-2px_-2px_1.5px_#8a8a8acc] hover:translate-y-[-2px] transform-gpu transition-all duration-300',
          'glass': variant === 'glass' && 'hover:translate-y-[-2px] transform-gpu'
        }[variant],
