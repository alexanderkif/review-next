          ...
          <div className={`flex flex-wrap gap-6`}>
            {value.map((imageId, index) => (
              <div key={imageId} className="relative px-2">
                ...
                <div className={`relative ${isAvatar ? 'w-20 h-20' : 'w-24 h-16'} rounded-xl shadow-[4px_4px_8px_#c5c5c5,_-2px_-2px_8px_#ffffff] border-2 border-slate-200`}>
                  ...
                  {!disabled && (
                    <button
                      ...
                      className="absolute -top-2 -right-5 w-6 h-6 rounded-full bg-gradient-to-br from-[#e8edf2] to-[#dfe7ed] text-red-600 hover:text-red-600 hover:from-[#edf2f7] hover:to-[#e5ecf1] shadow-[3px_3px_6px_#c5c5c5,_-1.5px_-1.5px_6px_#ffffff,_inset_-2px_-2px_1px_#8a8a8acc] transition-all duration-200 flex items-center justify-center cursor-pointer focus:outline-none"
                    >
                  ...
                  <button 
                    ...
                    className="absolute -bottom-2 -right-5 w-6 h-6 rounded-full bg-gradient-to-br from-[#e8edf2] to-[#dfe7ed] text-slate-700 shadow-[3px_3px_6px_#c5c5c5,_-1.5px_-1.5px_6px_#ffffff,_inset_-2px_-2px_1px_#8a8a8acc] text-sm font-bold flex items-center justify-center cursor-default"
                  >
