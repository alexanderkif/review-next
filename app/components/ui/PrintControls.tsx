  ...
  return (
    <div className={`flex gap-3 ${className}`}>
      <button
        ...
        className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium bg-gradient-to-r from-emerald-600 to-blue-600 text-white hover:from-emerald-500 hover:to-blue-500 hover:text-white shadow-[3px_3px_6px_#9ca3af,_-1.5px_-1.5px_6px_rgba(255,255,255,0.1),_inset_-2px_-2px_1px_rgba(0,0,0,0.3)] transition-all duration-200 will-change-auto disabled:opacity-75 disabled:cursor-wait cursor-pointer`}
        title="Save as PDF"
