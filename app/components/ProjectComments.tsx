...
export default function ProjectComments({ 
  ...
  return (
    <Card variant="glass" className="text-white animate-fade-in">
      <CardHeader>
            ...
            <div className="flex items-center justify-between p-4 bg-blue-500/20 backdrop-blur-sm rounded-lg border border-blue-500/30">
              ...
              <div className="flex gap-2">
                <Link href={`/login?callbackUrl=${encodeURIComponent(pathname)}`}>
                  <Button variant="ghost" size="sm" className="text-blue-200 hover:text-white min-h-[44px] min-w-[44px]">
                    Log In
                  </Button>
                </Link>
                <Link href={`/register?callbackUrl=${encodeURIComponent(pathname)}`}>
                  <Button variant="glass" size="sm" className="min-h-[44px] min-w-[44px]">
                    Register
                  </Button>
                </Link>
              </div>
