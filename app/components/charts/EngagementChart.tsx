...
const EngagementChart = ({ projects }: EngagementChartProps) => {
  const [period, setPeriod] = useState<'month' | 'year'>('month');
  const [data, setData] = useState<EngagementData[]>(() => generateDataFromProjects(projects || [], 'month'));
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <Button
              ...
              className="text-xs px-3 py-1 h-8 cursor-pointer"
            >
              1M
            </Button>
            <Button
