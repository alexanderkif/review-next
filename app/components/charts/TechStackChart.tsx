...
const DEFAULT_TECH_DATA: TechData[] = [
  ...
  { name: 'Tailwind CSS', value: 18, color: '#06B6D4' },
  { name: 'Node.js', value: 15, color: '#339933' },
  { name: 'PostgreSQL', value: 12, color: '#336791' },
  { name: 'Python', value: 10, color: '#3776AB' },
  { name: 'MongoDB', value: 8, color: '#47A248' },
  { name: 'JavaScript', value: 6, color: '#F7DF1E' },
  { name: 'Docker', value: 4, color: '#2496ED' },
];

export const TechStackChart = ({ projects }: TechStackChartProps) => {
  ...
  const getTechData = (): TechData[] => {
    ...
    // Если нет проектов или технологий, возвращаем данные по умолчанию
    ...
    return Object.entries(techCount)
      ...
      .slice(0, 13); // Показываем топ-13 технологий
  };
        ...
        <div className="block lg:hidden">
          <div className="flex gap-4">
            ...
            <div className="h-32 md:h-40 flex-1 min-h-[128px] md:min-h-[160px]">
              {isClient ? (
                <ResponsiveContainer width="100%" height="100%" minWidth={150} minHeight={120}>
                  <PieChart>
                    <Pie
                      data={data}
                      cx="50%"
