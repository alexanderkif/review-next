                ...
                <div className="relative">
                  <div className="p-1 bg-white shadow-[3px_3px_6px_#c5c5c5,_-1.5px_-1.5px_6px_#ffffff,_inset_-2px_-2px_1px_#8a8a8acc] rounded-3xl flex items-center justify-center">
                    <LazyAvatar
                      ...
                      size="md"
                      className="w-32 h-32 rounded-3xl transform translate-x-[-0.75px] translate-y-[-0.75px]"
                    />
                  </div>
                </div>
                  ...
                  <div className="flex gap-4 mt-4 justify-center md:justify-start">
                    {cvData.personalInfo.github && (
                      <a href={cvData.personalInfo.github} target="_blank" rel="noopener noreferrer">
                        <Button variant="clay" size="sm" className="p-2" aria-label="Visit GitHub profile">
                          <Github size={16} />
                        </Button>
                      </a>
                    )}
                    {cvData.personalInfo.linkedin && (
                      <a href={cvData.personalInfo.linkedin} target="_blank" rel="noopener noreferrer">
                        <Button variant="clay" size="sm" className="p-2" aria-label="Visit LinkedIn profile">
                          <Linkedin size={16} />
                        </Button>
                      </a>
                    )}
