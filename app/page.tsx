    ...
    <div className="min-h-screen bg-gradient-to-br from-[#e8edf2] via-[#f0f4f8] to-[#dfe7ed]">
      <div className="min-h-screen p-4 md:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Main information */}
          <Card variant="clay" className="mb-8 animate-fade-in">
            <CardContent>
                  ...
                  <div className="flex gap-4 mt-4 justify-center md:justify-start">
                    {cvData.personalInfo.github && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center p-2 rounded-xl bg-gradient-to-br from-[#e8edf2] to-[#dfe7ed] shadow-[3px_3px_6px_#c5c5c5,_-1.5px_-1.5px_6px_#ffffff,_inset_-2px_-2px_1px_#8a8a8acc] text-slate-700 hover:text-emerald-600 hover:from-[#edf2f7] hover:to-[#e5ecf1] transition-all focus:outline-none focus:ring-2 focus:ring-emerald-500/80"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Work Experience */}
            <Card variant="clay" className="animate-fade-in">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
