    ...
    <div className="page-glass">
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center max-w-2xl mx-auto">
          ...
          {/* Main message */}
          <Card variant="glass" className="text-white mb-8 animate-fade-in">
            <CardContent className="py-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/">
                  <Button variant="glass" size="md" className="flex items-center gap-2">
                    <Home size={18} />
                    Home
                  </Button>
                </Link>
          ...
          <Card variant="glass" className="text-white/70 animate-fade-in">
